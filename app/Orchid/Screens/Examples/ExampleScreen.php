...
class ExampleScreen extends Screen
{
    ...
    {
        return 'Off the record platform';
    }
    ...
    public function layout(): iterable
    {
        return [
            Layout::metrics([
                'Total figure'    => 'metrics.sales',
                'Total figure2' => 'metrics.visitors',
                'Total figure3' => 'metrics.orders',
                'Total figure4' => 'metrics.total',
            ]),

            Layout::tabs([
                'Total users' => Layout::view('platform::dummy.block'),
                'Client Status' => Layout::view('platform::dummy.block'),
                'Activities brief' => Layout::view('platform::dummy.block'),
            ]),
